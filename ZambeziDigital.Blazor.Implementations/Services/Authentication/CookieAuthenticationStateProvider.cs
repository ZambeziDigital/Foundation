...
using ZambeziDigital.Blazor.Implementations.Contracts.Authentication;
using ZambeziDigital.Blazor.Implementations.Models.Authentication;

namespace ZambeziDigital.Blazor.Implementations.Services.Authentication;
public class CookieAuthenticationStateProvider : AuthenticationStateProvider, IAccountManagement
    {
        ...
        /// <summary>
        /// ZambeziDigital.Blazor.Authentication state.
        /// </summary>
        ...
        /// </returns>
        public async Task<FormResult> RegisterAsync(BaseApplicationUserAddRequest appUser)
        {
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            try
            {
                ...
                var userInfo = JsonSerializer.Deserialize<BaseApplicationUserInfo>(userJson, jsonSerializerOptions);
                ...
                if (userInfo != null)
                {
                    ...
                    var claims = new List<Claim>
                    {
                        ...
                        new(ClaimTypes.Role, "Admin"), //TODO: Add role
